...
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <span>Laporan Konsultasi Sudah di Jawab</span>
            <div class="d-flex">
                <!-- Tombol Cetak PDF -->
                <a href="{{ route('report.konsultasi.dijawab.cetak-pdf') }}" class="btn btn-primary btn-icon-split">
        ...
        <div class="card-body">
            <!-- Filter Data -->
            <div class="mb-4">
                <form action="{{ route('kasubag.dijawab.konsultasi.filter') }}" method="GET" class="form-inline">
                    ...
                    <a href="{{ route('kasubag.dijawab.konsultasi.resetfilter') }}" class="btn btn-outline-secondary mb-2">
