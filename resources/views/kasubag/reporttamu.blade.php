...
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex">
                <!-- Tombol Cetak PDF -->
                <a href="{{ route('report.tamu.cetak-pdf', ['filter' => session('filter'), 'tanggal' => session('tanggal')]) }}"
        ...
        <div class="card-body">
            <!-- Filter Data -->
            <div class="mb-4">
                <form action="{{ route('kasubag.tamu.filter') }}" method="GET" class="form-inline">
                    ...
                    <a href="{{ route('kasubag.tamu.resetfilter') }}" class="btn btn-outline-secondary mb-2">
