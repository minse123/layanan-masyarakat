...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar ">
    ...
    <!-- Nav Item - Charts -->
    <li class="nav-item">
        <a class="nav-link" href="{{ route('operator.tamu') }}">
    ...
    <li class="nav-item">
        ...
        <div class="collapse" id="reportTamuCollapse">
            <div class="bg-white py-2 collapse-inner rounded">
                {{-- <a class="collapse-item" href="{{ route('harian-cetak') }}">Laporan Harian</a>
                <a class="collapse-item" href="{{ route('bulanan-cetak') }}">Laporan Bulanan</a>
                <a class="collapse-item" href="{{ route('tahunan-cetak') }}">Laporan Tahunan</a> --}}
            </div>
        </div>
    </li>
