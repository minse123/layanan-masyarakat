...
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <span>Laporan Konsultasi Pelatihan Inti</span>
            <div class="d-flex">
                <!-- Tombol Cetak PDF -->
        ...
        <div class="card-body">
            <!-- Filter Data -->
            <div class="mb-4">
                <form action="{{ route('konsultasi.inti.report') }}" method="GET" class="form-inline">
                    <div class="form-group mb-2 mr-2">
                        ...
                        <select name="jenis_pelatihan" id="jenis_pelatihan" class="form-control">
                            ...
                            <option value="bumdes" {{ request('jenis_pelatihan') == 'bumdes' ? 'selected' : '' }}>Bumdes
                            </option>
                            <option value="kpmd" {{ request('jenis_pelatihan') == 'kpmd' ? 'selected' : '' }}>KPMD
                            </option>
                            <option value="masyarakat_hukum_adat"
                                {{ request('jenis_pelatihan') == 'masyarakat_hukum_adat' ? 'selected' : '' }}>Masyarakat
                                Hukum Adat</option>
                            <option value="pembangunan_desa_wisata"
                                {{ request('jenis_pelatihan') == 'pembangunan_desa_wisata' ? 'selected' : '' }}>Pembangunan
                                Desa Wisata</option>
                            <option value="catrans" {{ request('jenis_pelatihan') == 'catrans' ? 'selected' : '' }}>Catrans
                            </option>
                    ...
                    <a href="{{ route('konsultasi.inti.report') }}" class="btn btn-outline-secondary mb-2">
