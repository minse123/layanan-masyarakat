...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <!-- Filter Data -->
            <div class="mb-4">
                <form action="{{ route('admin.dijawab.konsultasi.filter') }}" method="GET" class="form-inline">
                    ...
                    <a href="{{ route('admin.dijawab.konsultasi.resetfilter') }}" class="btn btn-outline-secondary mb-2">
