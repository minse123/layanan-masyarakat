...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('report-soal-pelatihan') }}" class="form-inline">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalImportSoal">
                            ...
                            <tr>
                                ...
                                {{-- <td>
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                        data-target="#modalDeleteSoal{{ $soal->id }}">
    ...
    <!-- Modal Import Soal -->
    @include('admin.soal.modals.import-soal') --}}
