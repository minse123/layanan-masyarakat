                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Keseluruhan
                                </div>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <a href="{{ route('statistik-tersulit.cetak-pdf') }}"
                                        class="btn btn-danger btn-sm">Cetak PDF</a>
                                </div>
                            </div>
                            <div class="col-auto">
                                ...
                                <tbody>
                                    @forelse ($recentSurat as $surat)
                                        <tr>
                                            ...
                                            <td><span
                                                    class="badge badge-{{ $surat->status == 'Proses' ? 'warning' : ($surat->status == 'Terima' ? 'success' : 'danger') }}">{{ $surat->status }}</span>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
