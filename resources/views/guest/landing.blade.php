            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <img src="/frontend/images/tablet-screen-contents.jpg" class="img-fluid" alt="">
                    </div>
                        ...
                        <div data-bs-spy="scroll" data-bs-target="#navbar-example3" data-bs-smooth-scroll="true"
                            ...
                            <div class="scrollspy-example-item" id="item-2">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12 mb-3">
                                        <img src="/frontend/images/portrait-mature-smiling-authoress-sitting-desk.jpg"
                                            class="scrollspy-example-item-image img-fluid" alt="">
                                    </div>

                                    <div class="col-lg-6 col-12 mb-3">
                                        <img src="/frontend/images/businessman-sitting-by-table-cafe.jpg"
                                            class="scrollspy-example-item-image img-fluid" alt="">
                                    </div>
                                </div>
                            ...
                            <div class="scrollspy-example-item" id="item-3">
                                ...
                                <p>Credit goes to <a rel="nofollow" href="https://freepik.com"
                                        target="_blank">FreePik</a> for images used in this ebook landing page
                                    template.
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-6 col-12">
                                        <img src="/frontend/images/tablet-screen-contents.jpg" class="img-fluid"
                                            alt="">
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="custom-block d-flex flex-wrap">
                            <div class="custom-block-image-wrap d-flex flex-column">
                                <img src="/frontend/images/avatar/pretty-blonde-woman.jpg"
                                    class="img-fluid avatar-image" alt="">
                            ...
                            <div class="ebook-download-form-body">
                                ...
                                <div class="input-group mb-4">
                                    <input type="email" name="ebook-email" id="ebook-email"
                                        pattern="[^ @]*@[^ @]*" class="form-control" placeholder="your@company.com"
